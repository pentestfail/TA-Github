...
import input_module_github_api_repos_issues as input_module
...
'''
    ...
    Add your modular input logic to file input_module_github_api_repos_issues.py
'''
class ModInputgithub_api_repos_issues(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputgithub_api_repos_issues, self).__init__("ta_github", "github_api_repos_issues", use_single_instance)
...
if __name__ == "__main__":
    exitcode = ModInputgithub_api_repos_issues().run(sys.argv)
    sys.exit(exitcode)
